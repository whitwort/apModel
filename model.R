...
sidebarFooter     <- "Version 0.2.  [Source code](https://github.com/whitwort/apModel) available on github."
modelDescription  <- "MODEL.md"

# Label formatters
stateFormat       <- function(name) { name }
parameterFormat   <- function(name) { name }
